...
[vfp9.iso](https://vfpxrepository.com/files/vfp9.zip) is an ISO file created from the VFP 9 installation CD. To install VFP 9, double-click the ISO file to open it in File Explorer, then run Setup.exe.
